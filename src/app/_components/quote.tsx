...
const Quote = ({ quote }: { quote: QuoteI }) => {
	return (
		<div className="p-8 xl:p-12 mx-8 !border-2 !border-primary !border-opacity-20 rounded-md !bg-custom-blue !bg-opacity-10 hover:bg-opacity-40">
			<Link href={`/projets/${quote.name}`} className="!no-underline flex flex-col gap-4 items-start justify-between h-[450px] lg:h-[450px]">
				<div className="">
					<Image
						alt={quote.name}
					...
					/>
					<p className="text-xs lg:text-base leading-6 line-clamp-10 lg:line-clamp-none xl:leading-10 !text-zinc-50">
						{quote.content}
					</p>
				</div>
