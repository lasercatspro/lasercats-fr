const Numbers = () => {
	return ( 
		<div className="py-32 bg-black">
			<div className="flex justify-between flex-col mx-2 md:grid md:grid-cols-3 md:px-8">
				<div className="flex flex-col lg:max-w-[30vw] text-center ">
					<p className="text-[5rem] lg:!text-[15rem] !text-zinc-100">50M</p>
				...
				<div className="flex flex-col lg:max-w-[30vw] text-center">
					<p className="text-[5rem] lg:!text-[15rem] !text-zinc-100">1M</p>
				...
				<div className="flex flex-col lg:max-w-[30vw] text-center">
					<p className="text-[5rem] lg:!text-[15rem] !text-zinc-100">11.4M</p>
