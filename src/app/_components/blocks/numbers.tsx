const Numbers = () => {
	return ( 
		<div className="px-4 md:px-16 py-32 bg-black">
			<div className="flex justify-between flex-col mx-2 md:grid md:grid-cols-3 gap-6">
				...
				<div className="flex flex-col items-end text-center">
					<p className="text-[6rem] lg:!text-[12rem] !text-zinc-100">11.4M</p>
