	...
	return (
		<footer className="flex flex-col justify-center gap-8 bg-custom-dark px-4 lg:px-12 pt-24 border-t-2 border-primary relative">
			...
			<div className="flex justify-between items-end pb-12">
				<p className="text-zinc-50">©{dayjs().format("YYYY")} - By Lasercats</p>
				{/* <ul className="flex gap-2 relative">
					<li>
						<Link href={"/"} className="text-sm hover:!no-underline text-zinc-50 hover:text-primary">Lasercats.fr</Link>
					</li>
					<li>
						<Link href={"/blog"} className="text-sm hover:!no-underline text-zinc-50 hover:text-primary">Blog</Link>
					</li>
					<li>
						<Link href={"/expertise"} className="text-sm hover:!no-underline text-zinc-50 hover:text-primary">Expertise</Link>
					</li>
					<li>
						<Link href={"/projets"} className="text-sm hover:!no-underline text-zinc-50 hover:text-primary">Nos projets</Link>
					</li>
				</ul> */}
...
<ul className="flex flex-col lg:ml-8 gap-2 relative lg:items-start">
<li>
