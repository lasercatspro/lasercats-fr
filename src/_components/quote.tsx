...
const Quote = ({ quote }: { quote: QuoteI }) => {
	return (
		<div className="p-8 xl:p-12 mx-2 !border !border-primary !border-opacity-20 rounded-md bg-gradient-to-t from-custom-dark to-[#141124] to-60% hover:!border-opacity-60">
